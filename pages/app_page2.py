...
df = pd.read_csv('DATA2/users.csv').drop_duplicates()
...
with open('DATA2/books.yaml', 'r', encoding='utf-8') as read_file:
...
df3 = pd.read_parquet('DATA2/orders.parquet').drop_duplicates()
...
st.set_page_config(page_title="Book Store Analytics - DATA 2", layout="wide")
st.title("📊 Book Store Analytics Dashboard for Data 2")
